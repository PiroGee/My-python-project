...
if not ques:
    print("⚠️ No questions found. Please add questions as admin first.")
    exit()
...
while not logout:
    ...
    if user_id == "admin01":
        ...
        print("Starting your exam... You have 5 minutes.\n")
        ...
        print(f"\nExam completed. You attempted {attempted} questions.")
